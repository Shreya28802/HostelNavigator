...
INSERT INTO `registration` (`id`, `roomno`, `seater`, `feespm`, `foodstatus`, `stayfrom`, `duration`, `course`, `regno`, `firstName`, `middleName`, `lastName`, `gender`,`cast`,`Engineering`, `contactno`, `emailid`, `egycontactno`, `guardianName`, `guardianRelation`, `guardianContactno`, `corresAddress`, `corresCIty`, `corresState`, `corresPincode`, `pmntAddress`, `pmntCity`, `pmnatetState`, `pmntPincode`, `postingDate`, `updationDate`) VALUES
...
INSERT INTO `userregistration` (`id`, `firstName`, `middleName`, `lastName`, `gender`,`cast`,`email`,`contactNo`, `Engineering`, `password`, `regDate`, `updationDate`, `passUdateDate`) VALUES
(10, 'onkar', 'sidling', 'kabure', 'male', 8975566181, 'test@gmail.com', 'Onkar','computer science engineering', '2016-06-22 04:21:33', '12-10-2023 06:51:50', '12-10-2023 06:53:14'),
