...
//$query="insert into  registration(roomno,seater,fees_Paid,feespm,stayfrom,duration,course,firstName,middleName,lastName,gender,cast,contactno,emailid,egycontactno,guardianName,guardianRelation,guardianContactno,corresAddress,corresCIty,corresState,corresPincode,pmntAddress,pmntCity,pmnatetState,pmntPincode) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
$query="insert into  registration(roomno,seater,fees_Paid,feespm,stayfrom,duration,course,firstName,middleName,lastName,gender,cast,Engineering,contactno,emailid,egycontactno,guardianName,guardianRelation,guardianContactno,corresAddress,corresCIty,corresState,corresPincode,pmntAddress,pmntCity,pmnatetState,pmntPincode) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";

$stmt = $mysqli->prepare($query);
//$rc=$stmt->bind_param('iiiiiisssssisississsissi',$roomno,$seater,$fees_Paid,$feespm,$stayfrom,$duration,$course,$regno,$fname,$mname,$lname,$gender,$contactno,$emailid,$emcntno,$gurname,$gurrelation,$gurcntno,$caddress,$ccity,$cstate,$cpincode,$paddress,$pcity,$pstate,$ppincode);
...
//$rc = $stmt->bind_param('iiiiiisssssisississsissi', $roomno, $seater, $fees_Paid, $feespm, $stayfrom, $duration, $course,  $fname, $mname, $lname, $gender, $contactno, $emailid, $emcntno, $gurname, $gurrelation, $gurcntno, $caddress, $ccity, $cstate, $cpincode, $paddress, $pcity);
$rc = $stmt->bind_param('iiiiiisssssssisississsisssi', $roomno, $seater, $fees_Paid, $feespm, $stayfrom, $duration, $course,  $fname, $mname, $lname, $gender,$cast,$Engineering, $contactno, $emailid, $emcntno, $gurname, $gurrelation, $gurcntno, $caddress, $ccity, $cstate, $cpincode, $paddress, $pcity,$pstate, $ppincode);
if (!$rc) {
...
$query1="insert into  userregistration(firstName,middleName,lastName,gender,cast,Engineering,contactNo,email) values(?,?,?,?,?,?,?,?)";
$stmt1= $mysqli->prepare($query1);
$stmt1->bind_param('ssssssis',$fname,$mname,$lname,$gender,$cast,$Engineering,$contactno,$emailid);
$stmt1->execute();
