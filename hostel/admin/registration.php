...
$query1="insert into  userregistration(firstName,middleName,lastName,gender,contactNo,email) values(?,?,?,?,?,?)";
$stmt1= $mysqli->prepare($query1);
$stmt1->bind_param('ssssis',$fname,$mname,$lname,$gender,$contactno,$emailid);
$stmt1->execute();
