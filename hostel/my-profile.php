...
$query="update  userRegistration set firstName=?,middleName=?,lastName=?,gender=?,contactNo=?,email=?,updationDate=? where id=?";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('ssssisi',$fname,$mname,$lname,$gender,$contactno,$email,$udate,$aid);
$stmt->execute();
