...
if (isset($_POST['submit'])) {
    ...
    if (isset($_POST['parentName'], $_POST['parentContact'], $_POST['parentAddress'])) {
        $parentName = $_POST['parentName'];
        $parentContact = $_POST['parentContact'];
        $parentAddress = $_POST['parentAddress'];

        // Check if any of the required fields are empty
        if (!empty($parentName) && !empty($parentContact) && !empty($parentAddress)) {

            $query = "INSERT INTO parents_records (parentName, parentContact, parentAddress) VALUES (?, ?, ?)";
            ...
            // Binding parameters
            $rc = $stmt->bind_param('sss', $parentName, $parentContact, $parentAddress);
            ...
            <div class="container-fluid">
                ...
                <form method="post" action="">
                    <div class="form-group" style="margin-top: 90px;">
                        ...
                        <div class="col-sm-18">
                            <input type="text" name="parentName" id="fname" class="form-control" required="required">
                        </div>
                    </div>
                    ...
                    <div class="form-group" style="margin-top: 20px;">
                        ...
                        <div class="col-sm-18">
                            <input type="text" name="parentContact" id="mname" class="form-control" required="required">
                        </div>
                    </div>
                    ...
                    <div class="form-group" style="margin-top: 20px;">
                        ...
                        <div class="col-sm-18" style ="margin-left: 10px;" >
                            <input type="text" name="parentAddress" id="lname" class="form-control" required="required">
                        </div>
                    </div>
