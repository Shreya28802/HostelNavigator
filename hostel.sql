...
(1, 'Komal', 'Ganesh', 'Chavan', 22, 2147483647, 'IN', '2024-02-06 05:04:09'),
(1, 'Komal', 'Ganesh', 'Chavan', 22, 2147483647, 'OUT', '2024-02-06 05:04:17'),
(1, 'Komal', 'Ganesh', 'Chavan', 22, 2147483647, 'OUT', '2024-02-06 05:06:29'),
(1, 'Komal', 'Ganesh', 'Chavan', 22, 2147483647, 'OUT', '2024-02-06 05:08:13'),
(38, 'Mrunali', 'Alaka', 'Chavan', 117, 2147483647, 'IN', '2024-02-06 05:29:22'),
(1, 'Komal', 'Ganesh', 'Chavan', 22, 2147483647, 'IN', '2024-02-06 05:35:39'),
(1, 'Komal', 'Ganesh', 'Chavan', 22, 2147483647, 'OUT', '2024-02-06 07:06:28');
...
--
-- Table structure for table `parents_records`
--

CREATE TABLE `parents_records` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `parents_records`
--

INSERT INTO `parents_records` (`id`, `parentName`, `parentContact`, `parentAddress`) VALUES
(1, 'Aai', '454544', 'male');
...
INSERT INTO `registration` (`id`, `roomno`, `seater`, `Fees_Paid`, `feespm`, `foodstatus`, `stayfrom`, `duration`, `course`, `firstName`, `middleName`, `lastName`, `gender`,`cast`,`contactno`, `emailid`, `egycontactno`, `guardianName`, `guardianRelation`, `guardianContactno`, `corresAddress`, `corresCIty`, `corresState`, `corresPincode`, `pmntAddress`, `pmntCity`, `pmnatetState`, `pmntPincode`, `postingDate`, `updationDate`) VALUES
(1, 22, 2, 100, 200, 0, '2024-02-14', 1, 'cse', 'Komal', 'Ganesh', 'Chavan', 'f','g', 7028146112, 'kc@gmai.com', 7028050845, 'ganesh', 'father', 100, 'palus', 'india', 'mh', 111222, 'sss', 'kkkk', 'asda', 123456, '2024-03-12 19:18:48', 'asda'),
...
(75, 10, 'test@gmail.com', 0x3a3a31, '', '', '2024-02-05 23:03:36');
...
CREATE TABLE `userregistration` (
  ...
  `cast` varchar(20) NOT NULL,
    `Engineering` varchar(20) NOT NULL,
...
INSERT INTO `userregistration` (`id`, `firstName`, `middleName`, `lastName`, `gender`,`cast`,`Engineering`,`contactNo`, `email`, `password`, `regDate`, `updationDate`, `passUdateDate`) VALUES
(10, 'onkar', '', 'kabure', 'male','open',`CSE`, 8975566181, 'test@gmail.com', 'Onkar', '2016-06-22 04:21:33', '12-10-2023 06:51:50', '12-10-2023 06:53:14'),
...
--
-- Table structure for table `workers_records`
--
...
--
-- Dumping data for table `workers_records`
--

INSERT INTO `workers_records` (`id`, `Name`, `Contact`, `purpose`) VALUES
(1, 'abc', '123', 'Option 2'),
(2, 'Mrunali Shivaji Chavan', '565656', 'Option 3');
...
--
-- Indexes for table `parents_records`
--
ALTER TABLE `parents_records`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `workers_records`
--
ALTER TABLE `workers_records`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `parents_records`
--
ALTER TABLE `parents_records`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `workers_records`
--
ALTER TABLE `workers_records`
